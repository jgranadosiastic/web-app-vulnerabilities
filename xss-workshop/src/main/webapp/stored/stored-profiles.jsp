...
<head>
    ...
    <style>
        ...
        .profile-form { background: #e7f3ff; padding: 20px; margin: 10px 0; }
        .profile { background: #f8f9fa; padding: 20px; margin: 10px 0; border: 2px solid #007bff; }
        .user-list { background: #fff3cd; padding: 15px; margin: 10px 0; }
